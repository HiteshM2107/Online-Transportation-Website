...
$name=$value["Name"];
	echo "Welcome ADMIN, hope you are having a good day!";
	?></h1></b><br><br>
	<font size="5">
		<a href="deleteuser.php" style="text-decoration:none; color:black;">
	<div id="g">	
		Delete User
	</div>
	<a href="addplace.php" style="text-decoration:none; color:black;">
	<div id="g">	
		Add Source/Destination Places
	</div>
	<a href="deleteplace.php" style="text-decoration:none; color:black;">
	<div id="g">
		Delete Source/Destination Places
	</div>
	</a>
