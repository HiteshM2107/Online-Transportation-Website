...
if($pass==$cpass)
{
	$sql="insert into data values('".$name."','".$email."','".$pass."')";
...
<body>
	...
	<div class="container" style="text-align:center; background-color:grey;">
		<br>
		<b><u><h1>Please fill the details to REGISTER</h1></b></u><br><br>
		<table align="center" width=25%><form method="post" action="<?php $_PHP_SELF ?>">
			<tr><td><b>Email :</b> </td><td><input type="email" name="email" placeholder="Enter Email ID" required></td></tr><tr><td colspan=2>&nbsp</td></tr>
			<tr><td><b>Name :</b> </td><td><input type="text" name="name" placeholder="Enter Name" required></td></tr><tr><td colspan=2>&nbsp</td></tr>
			<tr><td><b>Password :</b> </td><td><input type="password" name="pass" placeholder="Enter Password" required></td></tr>
			<tr><td colspan=2>&nbsp</td></tr>
			<tr><td><b>Confirm Password :</b> </td><td><input type="password" name="cpass" placeholder="Confirm Password" required></td></tr>
			<tr><td colspan=2>&nbsp</td></tr>
			<tr><td colspan=2><input type="submit" value="Register" name="RegisterButton"></td></tr>
		</form>
		</table>
		<div>
	<?php
	if($status==3)
		echo "<font color='red'>Make sure the passwords match each other.</font>";
	if($status==4)
		echo "<font color='red'>Sorry! Could Not Register.</font>";
	if($status==2)
		echo "<font color='green'>Successfully Registered. Thank You!</font>";
	?>
	</div>
		<br><br>
	</div>
