...
$pass=$_REQUEST["pass"];
if($pass=='Admin123' && $email=='Admin@gmail.com')
{	session_start();
	$_SESSION["Name"]=$email;
...
<body>
	<div style="position:fixed; top:300px; left:0px; color:white;">
		<div>
		<ul><li>|||
	...
	<div class="container" style="text-align:center; background-color:grey;">
		<br>
		<b><u><h1>Welcome ADMIN, Please LOGIN to continue</h1></b></u><br><br>
		<table align="center" width=25%><form method="post" action="<?php $_PHP_SELF ?>">
			...
			<tr><td colspan=2><input type="submit" value="Login" name="SignInButton"></td></tr>
		</form>
		</table>
		<div>
	<?php
