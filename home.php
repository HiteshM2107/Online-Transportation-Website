...
$name=$value["Name"];
	...
	?></h1></b><br><br>
	<font size="5">
		<a href="makeorder.php" style="text-decoration:none; color:black;">
	<div id="g">	
		Make Order
	</div>
	<a href="updateprofile.php" style="text-decoration:none; color:black;">
	<div id="g">	
		Update Profile
	</div>
	</a>
	<a href="uploadpic.php" style="text-decoration:none; color:black;">
	<div id="g">
