...
if($value["Password"]==$oldpassword)
  {
   if($newpassword==$confirmpassword)
	{
$sql="update data set Password='".$newpassword."' where Email='".$_SESSION["Name"]."'";
...
$statusError="Old Password Does Not Match";
}
?>
<!DOCTYPE html>
<html>
...
$email=$value["Email"];
	...
	<div>
		...
		<font size="3">
			Please Enter the Old Password to change the password.<br><br>
		<table align=center width=30%>
			<tr><td><b>Old Password: </b></td><td><input type="password" name="opass" placeholder="Enter Old Password"></td></tr>
			<tr><td>&nbsp</td><td>&nbsp</td></tr>
			<tr><td><b>New Password: </b></td><td><input type="password" name="npass" placeholder="Enter New Password"></td></tr>
			<tr><td>&nbsp</td><td>&nbsp</td></tr>
			<tr><td><b>Confirm Password: </b></td><td><input type="password" name="cpass" placeholder="Confirm Password"></td></tr>
			<tr><td>&nbsp</td><td>&nbsp</td></tr>
			<tr><td colspan=2><input type="submit" value="Save Changes" name="btn"></tr>
		</table>
		</font>
	</form>
	<br>
...
echo '<font color="red">'.$statusError."</font><br>";
